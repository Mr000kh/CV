        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-background shadow-lg">
              <img
                  src="/profile.jpeg"
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              ...
              for engineering software like Revit. I'm passionate about leveraging technology to solve complex problems
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Developed comprehensive Power BI dashboards for engineering departments, providing real-time insights
                  and KPI tracking.
                </p>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="list-disc pl-5 space-y-2 text-sm">
                  ...
                  <li>
                    Automated workflows in Revit using Python scripts in Dynamo, significantly enhancing design process
                    efficiency.
                  </li>
                  <li>
                    Designed and implemented a custom add-in to streamline repetitive tasks, reducing operational time.
                  </li>
                  <li>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="list-disc pl-5 space-y-2 text-sm">
                  ...
                  <li>
                    Collaborated with clients to gather requirements, evaluate project scope, and prepare quotations for
                    management review.
                  </li>
                  <li>
